...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gzen.ipc", false, filepath.Join(os.TempDir(), "gzen.ipc")},
		{"data", "gzen.ipc", false, "data/gzen.ipc"},
		{"data", "./gzen.ipc", false, "./gzen.ipc"},
		{"data", "/gzen.ipc", false, "/gzen.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gzen.ipc", true, `\\.\pipe\gzen.ipc`},
		{"data", "gzen.ipc", true, `\\.\pipe\gzen.ipc`},
		{"data", `\\.\pipe\gzen.ipc`, true, `\\.\pipe\gzen.ipc`},
	}
