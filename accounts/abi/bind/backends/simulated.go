...
// ZENA
// Simulated backend is retained and upstream changes are not applied as block production is still needed for ZENA
...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // Zenanet blockchain to handle the consensus
...
// See: https://github.com/zenanetwork/wiki/wiki/JSON-RPC-Error-Codes-Improvement-Proposal
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call zenanet.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) CallContractAtHash(ctx context.Context, call zenanet.CallMsg, blockHash common.Hash) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContractAtHead(ctx context.Context, call zenanet.CallMsg) ([]byte, error) {
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call zenanet.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call zenanet.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call zenanet.CallMsg, header *types.Header, stateDB *state.StateDB) (*core.ExecutionResult, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query zenanet.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query zenanet.FilterQuery, ch chan<- types.Log) (zenanet.Subscription, error) {
...
func (b *SimulatedBackend) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (zenanet.Subscription, error) {
