...
// valid Zenanet transaction.
type TransactOpts struct {
	From   common.Address // Zenanet account to send the transaction from
...
// Zenanet network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Zenanet blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Zenanet methods
...
// DeployContract deploys a contract onto the Zenanet blockchain and binds the
...
func (c *BoundContract) Call(opts *CallOpts, results *[]interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = zenanet.CallMsg{From: opts.From, To: &c.address, Data: input}
