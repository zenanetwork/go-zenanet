...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call zenanet.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call zenanet.CallMsg) ([]byte, error) {
...
func (mc *mockBlockHashCaller) CallContractAtHash(ctx context.Context, call zenanet.CallMsg, hash common.Hash) ([]byte, error) {
