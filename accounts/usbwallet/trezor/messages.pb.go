...
const (
	...
	// Zenanet
	MessageType_MessageType_ZenanetGetPublicKey     MessageType = 450
	MessageType_MessageType_ZenanetPublicKey        MessageType = 451
	MessageType_MessageType_ZenanetGetAddress       MessageType = 56
	MessageType_MessageType_ZenanetAddress          MessageType = 57
	MessageType_MessageType_ZenanetSignTx           MessageType = 58
	MessageType_MessageType_ZenanetTxRequest        MessageType = 59
	MessageType_MessageType_ZenanetTxAck            MessageType = 60
	MessageType_MessageType_ZenanetSignMessage      MessageType = 64
	MessageType_MessageType_ZenanetVerifyMessage    MessageType = 65
	MessageType_MessageType_ZenanetMessageSignature MessageType = 66
	// NEM
...
var (
	MessageType_name = map[int32]string{
		...
		450: "MessageType_ZenanetGetPublicKey",
		451: "MessageType_ZenanetPublicKey",
		56:  "MessageType_ZenanetGetAddress",
		57:  "MessageType_ZenanetAddress",
		58:  "MessageType_ZenanetSignTx",
		59:  "MessageType_ZenanetTxRequest",
		60:  "MessageType_ZenanetTxAck",
		64:  "MessageType_ZenanetSignMessage",
		65:  "MessageType_ZenanetVerifyMessage",
		66:  "MessageType_ZenanetMessageSignature",
	...
	MessageType_value = map[string]int32{
		...
		"MessageType_ZenanetGetPublicKey":                      450,
		"MessageType_ZenanetPublicKey":                         451,
		"MessageType_ZenanetGetAddress":                        56,
		"MessageType_ZenanetAddress":                           57,
		"MessageType_ZenanetSignTx":                            58,
		"MessageType_ZenanetTxRequest":                         59,
		"MessageType_ZenanetTxAck":                             60,
		"MessageType_ZenanetSignMessage":                       64,
		"MessageType_ZenanetVerifyMessage":                     65,
		"MessageType_ZenanetMessageSignature":                  66,
