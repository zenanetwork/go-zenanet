...
var flagMap = map[string][]string{
	...
	"mainnet":                          {"BoolFlag", "No"},
	"goerli":                           {"BoolFlag", "No"},
	"zena-mumbai":                      {"BoolFlag", "No"},
	"zena-amoy":                        {"BoolFlag", "No"},
	"zena-mainnet":                     {"BoolFlag", "No"},
	"sepolia":                          {"BoolFlag", "No"},
...
var nameTagMap = map[string]string{
	...
	"\"zena.logs\"":          "zena.logs",
	"url":                    "zena.iris",
	"\"zena.without\"":       "zena.withoutiris",
	"grpc-address":           "zena.irisgRPC",
	"\"zena.runiris\"":       "zena.runiris",
	"\"zena.runirisargs\"":   "zena.runirisargs",
	...
	"lightkdf":               "lightkdf",
	"disable-zena-wallet":    "disable-zena-wallet",
	"addr":                   "grpc.addr",
	"dev":                    "dev",
	"period":                 "dev.period",
}
...
func beautifyArgs(args []string) ([]string, []string) {
	...
	for j, val := range newArgs {
		if val == "-unlock" || val == "--unlock" {
			temp = append(temp, "--miner.zenbase")
