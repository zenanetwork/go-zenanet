...
// the main Zenanet network.
var MainnetBootnodes = []string{
	// Zenanet Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/zenanetwork/discv4-dns-lists for more
// information.
