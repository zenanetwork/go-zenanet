...
func (c *Command) Flags(config *Config) *flagset.Flagset {
	...
	f.StringFlag(&flagset.StringFlag{
		Name:    "chain",
		Usage:   "Name of the chain to sync ('pax', 'eirene', 'mainnet') or path to a genesis file",
	...
	f.BoolFlag(&flagset.BoolFlag{
		Name:    "zena.logs",
		Usage:   `Enables zena log retrieval`,
		Value:   &c.cliConfig.ZenaLogs,
		Default: c.cliConfig.ZenaLogs,
	})
	...
	f.StringFlag(&flagset.StringFlag{
		...
		Value:   &c.cliConfig.Sealer.Zenbase,
		Default: c.cliConfig.Sealer.Zenbase,
		Group:   "Sealer",
	})
	f.StringFlag(&flagset.StringFlag{
	...
	f.BoolFlag((&flagset.BoolFlag{
		Name:    "disable-zena-wallet",
		Usage:   "Disable the personal wallet endpoints",
		Value:   &c.cliConfig.Accounts.DisableZenaWallet,
		Default: c.cliConfig.Accounts.DisableZenaWallet,
	}))
