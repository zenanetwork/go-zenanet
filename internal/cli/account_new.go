...
func (a *AccountNewCommand) MarkDown() string {
	items := []string{
		"# Account new",
		"The `account new` command creates a new local account file on the Zena data directory. Zena should not be running to execute this command.",
		a.Flags().MarkDown(),
	}
