...
func (d *DebugPprofCommand) MarkDown() string {
	items := []string{
		"# Debug Pprof",
		"The ```debug pprof <enode>``` command will create an archive containing zena pprof traces.",
		d.Flags().MarkDown(),
	}
...
func (d *DebugPprofCommand) Help() string {
	return `Usage: zena debug

  Build an archive containing Zena pprof traces
...
func (d *DebugPprofCommand) Synopsis() string {
	return "Build an archive containing Zena pprof traces"
}
