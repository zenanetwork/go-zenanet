...
func (c *DumpconfigCommand) MarkDown() string {
	items := []string{
		"# Dumpconfig",
		"The ```zena dumpconfig <your-favourite-flags>``` command will export the user provided flags into a configuration file",
	}
...
func (c *DumpconfigCommand) Help() string {
	return `Usage: zena dumpconfig <your-favourite-flags>
