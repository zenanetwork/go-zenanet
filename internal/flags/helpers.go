...
func NewApp(usage string) *cli.App {
	...
	app.Usage = usage
	app.Copyright = "Copyright 2013-2024 The go-zenanet Authors"
...
// Example:
//
//	gzen account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
//	gzen --keystore /tmp/mykeystore --lightkdf account new
//
