...
import (
	...
	"github.com/zenanetwork/go-zenanet/internal/blocktest"
...
func newTestBackend(t *testing.T, n int, gspec *core.Genesis, engine consensus.Engine, generator func(i int, b *core.BlockGen)) *testBackend {
	...
	// gspec.Alloc[acc.Address] = types.Account{Balance: big.NewInt(params.Zen)}
...
func (b testBackend) SyncProgress() zenanet.SyncProgress { return zenanet.SyncProgress{} }
...
func (b testBackend) GetZenaBlockTransaction(ctx context.Context, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error) {
	tx, blockHash, blockNumber, index := rawdb.ReadZenaTransaction(b.ChainDb(), hash)
	return tx, blockHash, blockNumber, index, nil
}

func (b testBackend) GetZenaBlockTransactionWithBlockHash(ctx context.Context, txHash common.Hash, blockHash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error) {
	tx, blockHash, blockNumber, index := rawdb.ReadZenaTransactionWithBlockHash(b.ChainDb(), txHash, blockHash)
	return tx, blockHash, blockNumber, index, nil
}
...
func (b testBackend) GetZenaBlockLogs(ctx context.Context, hash common.Hash) ([]*types.Log, error) {
	receipt, err := b.GetZenaBlockReceipt(ctx, hash)
...
func (b testBackend) GetZenaBlockReceipt(ctx context.Context, hash common.Hash) (*types.Receipt, error) {
	receipt := b.chain.GetZenaReceiptByHash(hash)
	if receipt == nil {
...
func TestEstimateGas(t *testing.T) {
	...
	var (
		...
		genesis  = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				accounts[0].addr: {Balance: big.NewInt(params.Zen)},
				accounts[1].addr: {Balance: big.NewInt(params.Zen)},
			},
		}
		genBlocks      = 10
	...
	var testSuite = []struct {
		...
		},
		{
			...
			call:        TransactionArgs{},
			overrides: StateOverride{
				randomAccounts[0].addr: OverrideAccount{Balance: newRPCBalance(new(big.Int).Mul(big.NewInt(1), big.NewInt(params.Zen)))},
			},
			expectErr: nil,
			want:      53000,
		},
	...
	var (
		...
		genesis  = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				accounts[0].addr: {Balance: big.NewInt(params.Zen)},
				accounts[1].addr: {Balance: big.NewInt(params.Zen)},
				accounts[2].addr: {Balance: big.NewInt(params.Zen)},
				dad: {
					Balance: big.NewInt(params.Zen),
					Nonce:   1,
...
func TestSignTransaction(t *testing.T) {
	...
	genesis.Alloc[acc.Address] = types.Account{Balance: big.NewInt(params.Zen)}
...
func TestRPCGetBlockOrHeader(t *testing.T) {
	// Note: Upstream (gzen) tests have a different genesis hash as it has a different
	// state root hash due to allocating balance separately in test backend. Because
	// that is commented out in zena, we use the old genesis hash in the test files.
	...
	var (
		...
		genesis    = &core.Genesis{
			Config: params.TestChainConfig,
			Alloc: types.GenesisAlloc{
				acc1Addr: {Balance: big.NewInt(params.Zen)},
				acc2Addr: {Balance: big.NewInt(params.Zen)},
			},
		}
		genBlocks = 10
		signer    = types.HomesteadSigner{}
...
func setupTransactionsToApiTest(t *testing.T) (*TransactionAPI, []common.Hash, []struct {
	...
	var (
		...
		genesis    = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				...
				//     }
				// }
				contract: {Balance: big.NewInt(params.Zen), Code: common.FromHex("")},
			},
		}
	...
	backend.ChainConfig().Zena.Sprint["0"] = uint64(genBlocks)
...
func mockStateSyncTxOnCurrentBlock(t *testing.T, backend *testBackend) common.Hash {
	...
	types.DeriveFieldsForZenaLogs(stateSyncLogs, block.Hash(), block.NumberU64(), 0, 0)

	// Write zena receipt
	rawdb.WriteZenaReceipt(backend.ChainDb(), block.Hash(), block.NumberU64(), &types.ReceiptForStorage{
		Status: types.ReceiptStatusSuccessful, // make receipt status successful
		Logs:   stateSyncLogs,
	})

	// Write zena tx reverse lookup
	rawdb.WriteZenaTxLookupEntry(backend.ChainDb(), block.Hash(), block.NumberU64())
	return types.GetDerivedZenaTxHash(types.ZenaReceiptKey(block.NumberU64(), block.Hash()))
}
...
func setupBlocksToApiTest(t *testing.T) (*BlockChainAPI, rpc.BlockNumberOrHash, []struct {
	...
	backend.ChainConfig().Zena.Sprint["0"] = 1
