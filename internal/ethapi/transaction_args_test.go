...
func (b *backendMock) SyncProgress() zenanet.SyncProgress { return zenanet.SyncProgress{} }
...
func (b *backendMock) GetZenaBlockReceipt(ctx context.Context, hash common.Hash) (*types.Receipt, error) {
	//nolint: nilnil
	return nil, nil
}

func (b *backendMock) GetZenaBlockLogs(ctx context.Context, hash common.Hash) ([]*types.Log, error) {
	// nolint: nilnil
	return nil, nil
}

func (b *backendMock) GetZenaBlockTransaction(ctx context.Context, txHash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error) {
	return nil, common.Hash{}, 0, 0, nil
}

func (b *backendMock) GetZenaBlockTransactionWithBlockHash(ctx context.Context, txHash common.Hash, blockHash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error) {
	return nil, common.Hash{}, 0, 0, nil
}
