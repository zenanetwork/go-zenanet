...
// Package p2p implements the Zenanet p2p network protocols.
package p2p
...
import (
	...
	"github.com/zenanetwork/go-zenanet/p2p/enr"
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Zenanet Node Record
