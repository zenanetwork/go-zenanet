...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Zenanet address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Zenanet account at a particular block.
    type Account {
    ...
    # Transaction is an Zenanet transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Zenanet account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an Zenanet account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Zenanet block by number or by hash. If neither is
