...
// Package graphql provides a GraphQL interface to Zenanet node data.
package graphql
...
// Account represents an Zenanet account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Zenanet transaction.
...
type CallData struct {
	From                 *common.Address // The Zenanet address the call is from.
	To                   *common.Address // The Zenanet address the call is to.
