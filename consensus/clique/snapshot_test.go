...
// mapped from textual names used in the tests below to actual Zenanet private
...
// address retrieves the Zenanet address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Zenanet address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/zenanetwork/go-zenanet/issues/17593). Whilst this
