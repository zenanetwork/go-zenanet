...
// all blocks' seal as valid, though they still have to conform to the Zenanet
// consensus rules.
...
// still have to conform to the Zenanet consensus rules.
...
// they still have to conform to the Zenanet consensus rules.
