...
// timestampThreshold is the Zenanet mainnet genesis timestamp. It is used to
...
// NewID calculates the Zenanet fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Zenanet fork ID from an existing chain instance.
