...
// stateObject represents an Zenanet account which is being modified.
//
...
type stateObject struct {
	db       *StateDB
	address  common.Address      // address of zenanet account
	addrHash common.Hash         // hash of zenanet address of the account
