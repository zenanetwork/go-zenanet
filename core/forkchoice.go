...
type ForkChoice struct {
	...
	validator zenanet.ChainValidator
}
...
func NewForkChoice(chainReader ChainReader, preserve func(header *types.Header) bool, validator zenanet.ChainValidator) *ForkChoice {
...
func (f *ForkChoice) ValidateReorg(current *types.Header, chain []*types.Header) (bool, error) {
	// Call the zena chain validator service
	if f.validator != nil {
