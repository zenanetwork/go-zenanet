...
type Downloader struct {
	...
	syncStartBlock uint64    // Head snap block when Gzen was started
...
// nolint: staticcheck
func New(stateDb ethdb.Database, mux *event.TypeMux, chain BlockChain, lightchain LightChain, dropPeer peerDropFn, success func(), whitelistService zenanet.ChainValidator) *Downloader {
	if lightchain == nil {
		lightchain = chain
	}
...
// these are zero.
func (d *Downloader) Progress() zenanet.SyncProgress {
...
func (d *Downloader) GetWhitelistService() zenanet.ChainValidator {
