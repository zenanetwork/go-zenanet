...
func (api *DownloaderAPI) eventLoop() {
	var (
		...
		getProgress = func() zenanet.SyncProgress {
			prog := api.d.Progress()
...
// Syncing provides information when this node starts synchronising with the Zenanet network and when it's finished.
...
type SyncingResult struct {
	...
	Status  zenanet.SyncProgress `json:"status"`
}
