...
import (
	...
	"github.com/zenanetwork/go-zenanet/eth/tracers/internal"
	...
	jsassets "github.com/zenanetwork/go-zenanet/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-zenanet.
func init() {
	var err error
