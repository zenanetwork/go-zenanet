...
// FullSyncTester is an auxiliary service that allows Gzen to perform full sync
...
func RegisterFullSyncTester(stack *node.Node, backend *eth.Zenanet, target common.Hash) (*FullSyncTester, error) {
	cl := &FullSyncTester{
		stack:   stack,
		backend: backend,
		target:  target,
