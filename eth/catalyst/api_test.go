...
import (
	...
	beaconConsensus "github.com/zenanetwork/go-zenanet/consensus/beacon"
...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block) (*node.Node, *eth.Zenanet) {
	t.Helper()
...
func setupBlocks(t *testing.T, ethservice *eth.Zenanet, n int, parent *types.Header, callback func(parent *types.Header), withdrawals [][]*types.Withdrawal) []*types.Header {
	api := NewConsensusAPI(ethservice)
...
func TestWithdrawals(t *testing.T) {
	...
	// genesis.Config.ShanghaiBlock = &time
...
func setupBodies(t *testing.T) (*node.Node, *eth.Zenanet, []*types.Block) {
	genesis, blocks := generateMergeChain(10, true)
...
func TestParentBeaconBlockRoot(t *testing.T) {
	t.Skip("This test is not compatible with zena")
