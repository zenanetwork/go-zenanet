...
// Package filters implements an zenanet filtering system for block,
...
type Backend interface {
	...
	GetZenaBlockReceipt(ctx context.Context, blockHash common.Hash) (*types.Receipt, error)
	GetZenaBlockLogs(ctx context.Context, blockHash common.Hash) ([]*types.Log, error)
...
type EventSystem struct {
	...
	// Zena related subscription and channels
...
func (es *EventSystem) SubscribeLogs(crit zenanet.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeLogs(crit zenanet.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
