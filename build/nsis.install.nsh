Name "gzen ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/zenanetwork/go-zenanet/issues"
!define UPDATEURL "https://github.com/zenanetwork/go-zenanet/releases"
!define ABOUTURL "https://github.com/zenanetwork/go-zenanet#zenanet-go"
...
# Install gzen binary
Section "Gzen" GZEN_IDX
  SetOutPath $INSTDIR
  file {{.Gzen}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gzen.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gzen.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gzen incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gzen outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gzen UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gzen incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gzen.exe" "" "" "Zenanet" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gzen outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gzen.exe" "" "" "Zenanet" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gzen UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gzen.exe" "" "" "Zenanet" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ZENANET_SOCKET" "R" "HKLM" "\\.\pipe\gzen.ipc"
  ${EnvVarUpdate} $0 "ZENANET_SOCKET" "A" "HKLM" "\\.\pipe\gzen.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GZEN_IDX}
    SectionGetSize ${GZEN_IDX} $0
