...
import (
	...
	"github.com/zenanetwork/go-zenanet/internal/jsre/deps"
	"github.com/zenanetwork/go-zenanet/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Zenanet requests through
...
// Welcome show summary of current Gzen instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gzen JavaScript console!\n\n"

	// Print some generic Gzen metadata
