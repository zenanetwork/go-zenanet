...
Use `devp2p enrdump <base64>` to verify and display an Zenanet Node Record.
...
1. initialize the gzen node with the `genesis.json` file
2. import blocks from `chain.rlp`
3. run the client using the resulting database. For gzen, use a command like the one below:
...
[eth]: https://github.com/zenanetwork/devp2p/blob/master/caps/eth.md
[dns-tutorial]: https://gzen.ethereum.org/docs/developers/gzen-developer/dns-discovery-setup
[discv4]: https://github.com/zenanetwork/devp2p/tree/master/discv4.md
[discv5]: https://github.com/zenanetwork/devp2p/tree/master/discv5/discv5.md
