...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Zenanet presale wallets",
		ArgsUsage: "",
		Description: `
    gzen wallet import /path/to/my/presale.wallet

will prompt for your password and imports your zen presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Zenanet presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gzen wallet [options] /path/to/my/presale.wallet
...
between zenanet nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gzen account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gzen account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another zenanet instance,
