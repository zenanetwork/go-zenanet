...
// This test reproduces https://github.com/zenanetwork/go-zenanet/issues/17837 where the
...
// not respond.
// It reproducers the issue https://github.com/zenanetwork/go-zenanet/issues/30156
...
// It is the reproducer for https://github.com/zenanetwork/go-zenanet/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-zenanet-test-ipc-%d-%d", os.Getpid(), rand.Int63())
