...
var (
	_ = zenanet.ChainReader(&Client{})
	_ = zenanet.TransactionReader(&Client{})
	_ = zenanet.ChainStateReader(&Client{})
	_ = zenanet.ChainSyncReader(&Client{})
	_ = zenanet.ContractCaller(&Client{})
	_ = zenanet.GasEstimator(&Client{})
	_ = zenanet.GasPricer(&Client{})
	_ = zenanet.LogFilterer(&Client{})
	_ = zenanet.PendingStateReader(&Client{})
	// _ = zenanet.PendingStateEventer(&Client{})
	_ = zenanet.PendingContractCaller(&Client{})
)
...
// 	if err != nil {
// 		t.Fatalf("can't create new zenanet service: %v", err)
// 	}
...
func TestEthClient(t *testing.T) {
	t.Skip("zena due to burn contract")
