...
// Package ethclient provides a client for the Zenanet RPC API.
package ethclient
...
// Client defines typed wrappers for the Zenanet RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, zenanet.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*zenanet.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (zenanet.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q zenanet.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q zenanet.FilterQuery, ch chan<- types.Log) (zenanet.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q zenanet.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg zenanet.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg zenanet.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg zenanet.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*zenanet.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg zenanet.CallMsg) (uint64, error) {
...
//
// This can be used with CallContract and EstimateGas, and only when the server is Gzen.
...
func toCallArg(msg zenanet.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *zenanet.SyncProgress {
	if p == nil {
		return nil
	}
	return &zenanet.SyncProgress{
